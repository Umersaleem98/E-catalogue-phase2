                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-10 mb-3">
                                                        <select class="form-control" name="about_partner" id="alumni_select">
                                                            ...
                                                            <option value="Industrial-Partner" id="bp_eng_ug">Industrial Partner</option>
                                                            <option value="Philanthropist" id="Philanthropist_eng_ug">Philanthropist</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <script>
                                                    document.getElementById('select-single-noneng-ug').addEventListener('change', function () {
                                                        const philanthropistOneYearNonEngUgDiv = document.getElementById('philanthropist_oneyear_noneng_ug_div');
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12 additional-field" id="additionalFieldContainer"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="selectedDegree" name="degree_name"
                                            ...
                                            <div class="container-fluid">
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-10 mb-3">
                                                        <select class="form-control" name="about_partner" id="select-one-year-custom-ug">
                                                            <option value="" disabled selected>Select an option</option>
                                                            <option value="Alumni">Alumni</option>
                                                            <option value="Industrial-Partner" id="ip_custom_oneyear_ug">Industrial Partner</option>
                                                            <option value="Philanthropist" id="Philanthropist_custom_oneyear_ug">Philanthropist</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    document.getElementById('select-one-year-custom-ug').addEventListener('change', function () {
                                                        const philanthropistOneYearCustomUgDiv = document.getElementById('philanthropist_oneyear_custom_ug_div');
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-10 mb-3">
                                                        <select class="form-control" name="about_partner" id="select-oneyear-eng-pg">
                                                            <option value="" disabled selected>Select an option</option>
                                                            <option value="Alumni">Alumni</option>
                                                            <option value="Industrial-Partner" id="ip_one_year_eng_pg">Industrial Partner</option>
                                                            <option value="Philanthropist" id="Philanthropist_one_year_eng_pg">Philanthropist</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-10 mb-3">
                                                        <select class="form-control" name="about_partner" id="select-oneyear-neng-pg">
                                                            <option value="" disabled selected>Select an option</option>
                                                            <option value="Alumni">Alumni</option>
                                                            <option value="Industrial-Partner" id="ip_one_year_noneng_pg">Industrial Partner</option>
                                                            <option value="Philanthropist" id="Philanthropist_one_year_noneng_pg">Philanthropist</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row ml-3">
                                                    ...
                                                    <div class="col-md-10 mb-3">
                                                        <select class="form-control" name="about_partner" id="select-one-year-custom-pg">
                                                            <option value="" disabled selected>Select an option</option>
                                                            <option value="Alumni">Alumni</option>
                                                            <option value="Industrial-Partner" id="ip_one_year_custom_pg">Industrial Partner</option>
                                                            <option value="Philanthropist" id="Philanthropist_one_year_custom_pg">Philanthropist</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <select name="school" id="school_select"
                                                            ...
                                                            <option
                                                                ...
                                                                SCEE</option>
                                                            <option
                                                                value="SCHOOL OF CHEMICAL & MATERIALS ENGINEERING">
                                                                SCME</option>
                                                            <option
                                                                value="SCHOOL OF ELECTRICAL ENGINEERING & COMPUTER SCIENCE">
                                                                SEECS</option>
                                                            ...
                                                            <option value="COLLEGE OF AERONAUTICAL ENGINEERING">
                                                                COLLEGE OF AERONAUTICAL ENGINEERING</option>
                                                            <option
                                                                value="COLLEGE OF ELECTRICAL & MECHANICAL ENGINEERING">
                                                                COLLEGE OF EME</option>
                                                            <option value="MILITARY COLLEGE OF ENGINEERING">MCE
                                                            ...
                                                            <option
                                                                value="CENTRE FOR INTERNATIONAL PEACE & STABILITY">
                                                                CIPS</option>
                                                            <option
                                                                value="NUST INSTITUTE OF PEACE & CONFLICT STUDIES">
                                                                NUST IPCS</option>
                                                            <option value="SCHOOL OF SOCIAL SCIENCES & HUMANITIES">
                                                                SSSH</option>
                                                            <option
                                                                value="ATTA-UR-RAHMAN SCHOOL OF APPLIED BIO SCIENCES">
                                                                ASABS</option>
